...
import backgroundImage from './../../../assets/images/backgroundQuemSomos.png'; 
  ...
  return (
    <div className={styles.quemSomosContainer}>
      ...
      <div className={`${styles.descricaoContainer} ${styles.descricao}`}>
        ...
        Acreditamos que o consumo consciente é a chave para um futuro mais sustentável e justo.<br/>
